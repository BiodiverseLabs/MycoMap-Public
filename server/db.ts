...
export class DatabaseStorage implements IStorage {
      ...
      WITH global_rankings AS (
        SELECT 
          ...
          CASE 
            ...
            THEN SPLIT_PART(inat.photos[1], '?', 1)
  ...
  async getValidationData(params: {
    ...
    let sqlQuery = `
      SELECT 
        ...
        COALESCE(o.mycomap_blast_url, i.mycomap_blast_results) as "mycoMapBlastResults",
        COALESCE(o.mycomap_blast_url, i.mycomap_blast_results) as "mycoMapBlastUrl",
        ...
        COALESCE(o.mycomap_trace_url, i.trace_files) as "mycoMapTraceUrl",
        o.fastq_file as "fastqFile",
        o.trace_files_downloaded as "traceFilesDownloaded", 
        o.trace_download_date as "traceDownloadDate",
        COALESCE(o.mycomap_trace_url, i.trace_files) as "traceFiles",
  ...
  async createBiorecord(observationData: any): Promise<Biorecord> {
    const biorecordData: InsertBiorecord = {
      ...
      firstGenbankRecord: observationData.firstGenbankRecord || false,
      isFirstStateRecord: observationData.isFirstStateRecord || false,
      hasMultipleGenotypes: observationData.hasMultipleGenotypes || false,
