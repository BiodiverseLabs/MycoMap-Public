    ...
    try {
      ...
      const prospectsQuery = sql`
        ...
        SELECT 
          ...
          o.common_name,
          SUM(CASE 
            WHEN o.latitude > ${centerLat} AND ABS(o.latitude - ${centerLat}) > ABS(o.longitude - ${centerLon}) 
            THEN 1 ELSE 0 END) as north_count,
          SUM(CASE 
            WHEN o.latitude < ${centerLat} AND ABS(o.latitude - ${centerLat}) > ABS(o.longitude - ${centerLon}) 
            THEN 1 ELSE 0 END) as south_count,
          SUM(CASE 
            WHEN o.longitude > ${centerLon} AND ABS(o.longitude - ${centerLon}) > ABS(o.latitude - ${centerLat}) 
            THEN 1 ELSE 0 END) as east_count,
          SUM(CASE 
            WHEN o.longitude < ${centerLon} AND ABS(o.longitude - ${centerLon}) > ABS(o.latitude - ${centerLat}) 
            THEN 1 ELSE 0 END) as west_count,
